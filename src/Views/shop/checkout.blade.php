                        ...
                        <div class="col-md-12">
                            <div class="mb-2 border-solid border-grey-light rounded border shadow-sm">
                                ...
                                <div class="p-3 bg-white">
                                    @include('causeway::shop.partials.checkout._billingInfo')
                                    @include('causeway::shop.partials.checkout._shippingInfo')
                                    <hr/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            @include('causeway::shop.partials.checkout._shipping')
                            @include('causeway::shop.partials.checkout._payment')
                        </div>
                        <div class="col-md-12">
                            @include('causeway::shop.partials.checkout._totals')
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
