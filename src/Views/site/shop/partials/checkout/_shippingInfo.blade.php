...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        @include('site::layouts.partials.common._error', ['name' => 'shipping_first_name'])
    </div>
    <div class="form-group col-md-6">
        ...
        @include('site::layouts.partials.common._error', ['name' => 'shipping_last_name'])
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-8">
        ...
        @include('site::layouts.partials.common._error', ['name' => 'shipping_address'])
    </div>
    <div class="form-group col-md-2">
        ...
        @include('site::layouts.partials.common._error', ['name' => 'shipping_address_number'])
    </div>
    <div class="form-group col-md-2">
        ...
        @include('site::layouts.partials.common._error', ['name' => 'shipping_address_suffix'])
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-5">
        ...
        @include('site::layouts.partials.common._error', ['name' => 'shipping_city'])
    </div>
    <div class="form-group col-md-5">
        ...
        @include('site::layouts.partials.common._error', ['name' => 'shipping_country'])
    </div>
    <div class="form-group col-md-2">
        <label for="shipping_zipcode">{{ __('Zipcode') }}</label>
        {{ Form::text('shipping_zipcode', null, ['class' => 'form-control', 'id' => 'shipping_zipcode']) }}
        @include('site::layouts.partials.common._error', ['name' => 'shipping_zipcode'])
    </div>
</div>