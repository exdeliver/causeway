...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        @include('site::layouts.partials.common._error', ['name' => 'first_name'])
    </div>
    <div class="form-group col-md-6">
        <label for="last_name">{{ __('Last name') }}</label>
        {{ Form::text('last_name', null, ['class' => 'form-control', 'id' => 'last_name']) }}
        @include('site::layouts.partials.common._error', ['name' => 'last_name'])
    </div>
</div>
...
<div class="form-group">
    ...
    @include('site::layouts.partials.common._error', ['name' => 'email'])
</div>
...
<div class="form-group">
    ...
    @include('site::layouts.partials.common._error', ['name' => 'email_confirmation'])
</div>

<div class="form-group">
    <label for="company">{{ __('Company') }}</label>
    {{ Form::text('company', null, ['class' => 'form-control', 'id' => 'company']) }}
    @include('site::layouts.partials.common._error', ['name' => 'company'])
</div>

<div class="form-group">
    <label for="phone">{{ __('Phone number') }}</label>
    {{ Form::text('phone', null, ['class' => 'form-control', 'id' => 'phone']) }}
    @include('site::layouts.partials.common._error', ['name' => 'phone'])
</div>
